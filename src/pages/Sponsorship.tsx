...
const Sponsorship: React.FC = () => {
    ...
    return (
        <div>
            ...
            <Paragraph
            text=
            '　iGEM TSUKUBAは合成生物学を様々な分野に応用しながら研究を進め、合成生物学の世界大会であるiGEMに出場して受賞することを掲げて活動しております。しかし、iGEMへの参加には研究費も含めて非常に多くの資金が必要です。\r\n　具体的には、iGEMへの参加登録費のみで少なくとも$5500 USD、日本円で約80万円もの資金が必要です。これ以外にチームとしての出場費約43万円、チームメンバー1人あたりの出場費が8万円かかる(*1)など、渡航費も含めれば出場だけで約200万円以上がかかります。加えて研究費もあるため、学生が自身で全額用意するのは難しいところがあります。'
            />
            
            <Paragraph text=
            '　そこで合成生物学にご興味がある方や、その分野において研究を進め、iGEMに出場する私たちを応援してくださる方を募集しています。2022年始動の歴史が浅いチームではありますが、初出場で獲得したsilver medalを超える結果を目指して日々邁進しております。私たちの活動に賛同し、ご支援いただける方をお待ちしております。 '
            />
