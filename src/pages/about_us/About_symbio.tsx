    ...
    return (
        <div>
           ...
           <UpperHeader></UpperHeader>
            ...
            <Image src= 'pages\about_us\About_symbio\symbio.webp' 
                   alt= '合成生物学' 
                   caption= ''
                   width={400}
                   borderRadius={5} 
            ...
            <Image src= 'pages\about_us\About_symbio\goldenrice.webp' 
                   alt= 'ゴールデンライス' 
                   caption= 'ゴールデンライス'
                   width={400}
                   borderRadius={5} 
            ...
            <Image src= 'pages\about_us\About_symbio\aidrug.webp' 
                   alt= 'AI創薬' 
                   caption= ''
                   width={400}
                   borderRadius={5} 
            ...
            <Image src= 'pages\about_us\About_symbio\environment.webp' 
                   alt= 'environment' 
                   caption= ''
                   width={400}
                   borderRadius={5} 
