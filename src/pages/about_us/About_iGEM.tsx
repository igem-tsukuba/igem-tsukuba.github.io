...
const AboutIGEM: React.FC = () => {
    return (
        ...
        <Title
            text='目標'/>   
        <Paragraph
            text='　iGEMの大会の狙いは、合成生物学の発展、教育、競争、オープンで協力的なコミュニティの発展にあります。そのため、大会では研究成果に加え、教育活動、webページの作成、などの多角的な視点から総合的に評価されます。17の特別賞と金、銀、銅の3つのメダルの賞があり、3つ以上の特別賞獲得者が金メダルの獲得対象となります。これは研究内容のみが評価される一般的な大会とは異なり、iGEMでは多岐に渡る能力が求められることを意味します。' />
        <Image
...
<Title
        ...
        <Paragraph
            text='　他にも、評価基準には含まれませんが、研究活動や大会出場に必要な資金調達、宣伝活動なども独自に行います。\r\n　このように、様々な活動がこの大会では求められ、生物学以外の分野に長けた人材にも活躍の場があります。研究業界などで将来的に重要となるこのような総合的活動を学生のうちから経験できるのはこの大会の魅力の一つでしょう。'/> 
